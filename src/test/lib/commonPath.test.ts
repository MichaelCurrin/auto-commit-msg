...
test("Split an array of strings at a separator", function () {
  test("#_splitStrings", function () {
    test("should split 3 strings correctly with the default separator", function () {
...
test("Find the highest common parent directory for paths", function () {
  ...
  test("#commonPath", function () {
    test("should give the common path for 3 root repo paths", function () {
    ...
    test("should give the common path for 2 different paths", function () {
      const paths = ["Foo/test", "Foo/bar/test"];

      assert.strictEqual(commonPath(paths), "Foo");
    });

    test("should give the common path for 3 similar repo paths", function () {
      const paths = [
    ...
    test("should give the common path for 3 related absolute paths", function () {
      const paths = [
