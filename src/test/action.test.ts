...
describe('Desribe a file moved or renamed', function() {
  describe('#moveRenamePath()', function() {
    it('describes a renamed file', function() {
    ...
    it('describes a moved file', function() {
    ...
    it('describes a remamed and moved file', function() {
      assert.equal(
        moveRenamePath('foo.txt', 'fizz/bar.txt'),
        'Move and rename foo.txt to fizz/bar.txt'
      );
      // This is a rare case, so don't bother trying to handle it smarter around paths.
      assert.equal(
        moveRenamePath('fuzz/foo.txt', 'fizz/bar.txt'),
        'Move and rename foo.txt to fizz/bar.txt'
      );
      assert.equal(
        moveRenamePath('fizz/foo.txt', 'bar.txt'),
