...
This was inspired partly by GitHub's UI - it suggests a message in grey like "Update README.md" when I edit that file and if I enter nothing it uses that. Perhaps a way in this extension to get close to that flow is to listen for when files are _staged_ on _unstaged_ and then push a message to the input box for you.
...
- [ ] Use semantic commit message e.g. `chore: Update package.json`
